...
set rc [catch {
  ...
  set_property webtalk.parent_dir J:/jford/project/Final/DEMO/project_2/project_2.cache/wt [current_project]
  set_property parent.project_path J:/jford/project/Final/DEMO/project_2/project_2.xpr [current_project]
  set_property ip_repo_paths J:/ekanakap/median_float/solution1/impl/ip [current_project]
  update_ip_catalog
  set_property ip_output_repo J:/jford/project/Final/DEMO/project_2/project_2.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
  add_files -quiet J:/jford/project/Final/DEMO/project_2/project_2.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files J:/jford/project/Final/DEMO/project_2/project_2.srcs/sources_1/bd/design_1/design_1.bd
